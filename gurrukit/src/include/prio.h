...
extern "C" {
	...
	typedef  LONG(__cdecl* FUNC_PR_Read)		(HANDLE fd, PCHAR buf, LONG amount, PVOID context);
	typedef  LONG(__cdecl* FUNC_PR_Write)		(HANDLE fd, PCHAR buf, LONG amount, PVOID context);
	typedef  LONG(__cdecl* FUNC_PR_Close)		(HANDLE fd, PVOID context);
	typedef  LONG(__cdecl* FUNC_PR_GetError)	(PVOID context);
	typedef  VOID(__cdecl* FUNC_PR_SetError)	(LONG errorCode, LONG oserr, PVOID context);
	typedef	 LONG(__cdecl* FUNC_PR_Poll)		(PRPollDesc *pds, LONG npds, LONG timeout);

	LONG	__cdecl	PR_Close(HANDLE fd);
	LONG	__cdecl	PR_Read(HANDLE fd, PCHAR buf, LONG amount);
	LONG	__cdecl	PR_Write(HANDLE fd, PCHAR buf, LONG amount);
	LONG	__cdecl	PR_GetError(VOID);
	VOID	__cdecl	PR_SetError(LONG errorCode, LONG oserr);
	LONG	__cdecl	PR_Poll(PRPollDesc *pds, LONG npds, LONG timeout);
